<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Reports.aspx.cs" Inherits="User_Reports" %>
        ...
        <asp:TableRow>
             <asp:TableCell>
                 <asp:DropDownList ID="ReportSelection" runat="server">
                     ...
                     <asp:ListItem Value="Statement of Retained Earnings">Statement of Retained Earnings</asp:ListItem>

<%@ Page Title="" Language="C#" MasterPageFile="~/Manager.master" AutoEventWireup="true" CodeFile="ChartAccounts.aspx.cs" Inherits="Manager_ChartAccounts" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TeamCacAh4UPauaPConnectionString %>" SelectCommand="SELECT [acct_name], [acct_id], [active], [acct_bal], [created_by], [created_at], [last_updated], [last_updated_by] FROM [Accounts]"></asp:SqlDataSource>
</asp:Content>
